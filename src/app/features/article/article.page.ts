...
import { contrastOutline, globeOutline, headsetOutline, imageOutline, shareOutline, star, starOutline, textOutline, volumeHighOutline } from 'ionicons/icons';
...
export class ArticlePage implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private db: StoragePort, private http: FeedHttpService, private sanitizer: DomSanitizer, public prefs: ListPreferencesService, private tts: TtsService, private player: PodcastPlayerService) {
    addIcons({ shareOutline, star, starOutline, volumeHighOutline, globeOutline, textOutline, contrastOutline, imageOutline, headsetOutline });
  }
