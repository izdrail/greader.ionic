...
export class SubscriptionsPage implements OnInit{
  ...
  constructor(private db:StoragePort,public prefs:ListPreferencesService){addIcons({reorderTwoOutline});}
