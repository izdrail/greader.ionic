...
export abstract class StoragePort {
  ...
  abstract updateArticle(id: string, change: Partial<Article>): Promise<void>; abstract markArticlesRead(accountId: string, options?: { before?: number; now?: number }): Promise<number>; abstract clearCachedArticles(accountId: string): Promise<number>; abstract deleteSubscription(id: string): Promise<void>;
